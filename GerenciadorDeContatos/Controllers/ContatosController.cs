...
namespace GerenciadorDeContatos.Controllers
{
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,numero,Nome")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,numero,Nome")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
